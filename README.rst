...
This project's code and documentation were generated by AI coding
assistants (Claude, Codex, and Gemini). It has not been independently
audited; review it carefully before relying on it in production,
particularly the parts that handle SMS gateway credentials and personal
data.
